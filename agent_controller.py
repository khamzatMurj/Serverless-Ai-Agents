...
class AgentController():
    def __init__(self):
        ...
        self.recommendation_agent = RecommendationAgent('/app/recommendation_objects/apriori_recommendations.json',
                                                        '/app/recommendation_objects/popularity_recommendation.csv'
                                                        )
