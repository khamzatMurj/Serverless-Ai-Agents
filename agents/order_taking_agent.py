...
from agents.utils.utils import get_chatbot_response, double_check_json_output
import json
import pandas as pd
import dotenv
dotenv.load_dotenv()
    ...
    def get_response(self, message):
        ...
        system_prompt = """
            ...
            * Don't tell the user to go to place to get the order
            ...
            Your output should be in a structured json format like so. each key is a string and each value is a string must be with double quotes. Make sure to follow the format exactly:
            {
